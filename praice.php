...
<td height="30px" style="border-bottom:1px solid #c6d5e1;"><table><tr><td><table><tr><td><form method="post"><select name="price_select" onChange="javascript:form.submit()">
	<?php 
	if (!isset($_SESSION['price_select'])) { $_SESSION['price_select'] = 'Товары';} else { if (isset($_POST['price_select'])) {$_SESSION['price_select'] = $_POST['price_select'];}}
	if ($_SESSION['price_select'] == 'Товары') {printf("<option selected='selected' value='Товары'>Товары</option>");} else {printf("<option value='Товары'>Товары</option>");}
	if ($_SESSION['price_select'] == 'Тарифы') {printf("<option selected='selected' value='Тарифы'>Тарифы</option>");} else {printf("<option value='Тарифы'>Тарифы</option>");}
	?>
...
if ($_SESSION['price_select'] == 'Товары') {
...
<?php if ($_SESSION['price_select'] == 'Товары') {	printf(" 			
				...
				<th><h3>Стоимость подключения</h3></th>
