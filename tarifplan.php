...
<tr>
<td style="border-bottom:1px solid #c6d5e1;" align="center"><form action="update/insert_tarifplan.php" method="post"><table><tr><td align="center">Оператор</td><td align="center">Тарифный план</td><td align="center">Стоимость подключения</td><td align="center">Вознаграждение</td></tr><tr><td><select name="selected_op" onChange="this.form.submit();">
	<?php 
	...
	<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable" width="700">
		<thead>
			<tr>
				...
				<th width="200" ><h3>Оператор</h3></th>
				<th width="200" ><h3>Тарифный план</h3></th>
				<th width="200" ><h3>Стоимость подключения</h3></th>
