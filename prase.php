...
<tr>
<td style="border-bottom:1px solid #c6d5e1;" align="left"><table><tr><td width="90" align="center"><a class="like_button" href="shtrihkod.php">Штрих-код</a></td><td width="150" align="center"><a class="like_button" href="serialnum.php">Серийные номера</a></td><td width="150" align="center"><a class="like_button" href="akciya.php">Акционное оборуд.</a></td><td><form action="update/insert_prase.php" method="post"><table><tr><td align="center">Категория</td><td align="center">Наименование товара</td><td align="center">Цена</td><td align="center">Вознаг.</td></tr><tr><td><select name="kateg" onChange="this.form.submit();">
	<?php
