...
$myrow = mysql_fetch_array($result);
	...
	if ($myrow['b'] == "А") {$type = 'Аксесуары';}
	if ($myrow['b'] == "Т") {$type = 'Терминалы';}
	if ($myrow['b'] == "С") {$type = 'Стартовые';}
	if ($myrow['b'] == "П") {$type = 'Подключения';} 
