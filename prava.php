...
<tr><td>Перемещения</td><td><?php if ($priv_vot[3]==1) {printf("<input type=\"checkbox\" name=\"vot_priv_per\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"vot_priv_per\">");};?></td>
    <td>----</td>
	<td>----</td></tr>	
<tr><td>Продажи</td><td><?php if ($priv_vot[4]==1) {printf("<input type=\"checkbox\" name=\"vot_priv_pro\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"vot_priv_pro\">");};?></td>
...
<tr><td>Ремонты</td><td><?php if ($priv_vot[6]==1) {printf("<input type=\"checkbox\" name=\"vot_priv_rem\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"vot_priv_rem\">");};?></td>
    <td><?php if ($priv_aed[6]==1) {printf("<input type=\"checkbox\" name=\"add_priv_rem\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"add_priv_rem\">");};?></td>
	<td><?php if ($priv_aed[7]==1) {printf("<input type=\"checkbox\" name=\"ed_priv_rem\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"ed_priv_rem\">");};?></td></tr>
<tr><td>Возвраты</td><td><?php if ($priv_vot[7]==1) {printf("<input type=\"checkbox\" name=\"vot_priv_voz\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"vot_priv_voz\">");};?></td>
    <td><?php if ($priv_aed[8]==1) {printf("<input type=\"checkbox\" name=\"add_priv_voz\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"add_priv_voz\">");};?></td>
	<td><?php if ($priv_aed[9]==1) {printf("<input type=\"checkbox\" name=\"ed_priv_voz\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"ed_priv_voz\">");};?></td></tr>
<tr><td>Отчеты</td><td><?php if ($priv_vot[8]==1) {printf("<input type=\"checkbox\" name=\"vot_priv_otch\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"vot_priv_otch\">");};?></td>
<td>----</td><td><?php if ($priv_aed[10]==1) {printf("<input type=\"checkbox\" name=\"ed_priv_otch\" value=\"1\" checked>");} else {printf("<input type=\"checkbox\" name=\"ed_priv_otch\">");};?></td></tr>
</tbody></table>
</td></tr><tr><td>
