...
<tr>
<td style="border-bottom:1px solid #c6d5e1;" align="center"><table><tr><td width="150" align="center"><a class="like_button" href="archive_popoln.php">Архив пополнений</a></td><td><form action="update/insert_operatoru.php" method="post"><table><tr><td align="center">Имя оператора</td><td align="center">Тип счета</td><td align="center">Баланс</td><td></td></tr><tr><td><input type="text" name="oper"></td><td><select name="priznak"><option value="Нет" selected="selected">Нет</option><option value="Тарыфный план">Тарыфный план</option><option value="Оборудование">Оборудование</option><option value="Тарыфный план + Оборудование">Тарыфный план+Оборудование</option></select></td><td><input type="text" name="schet"></td><td><input type="submit" value="Добавить"></td></tr></table></form></td></tr></table></td>
</tr>
	...
	<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
		<thead>
			<tr>
				...
				<th width="100"><h3>Имя оператора</h3></th>
...
do {
	printf("<tr><td width=15 align='center'><a href=\"form/page_popolnenie.php?id=%s\" rel=\"#overlay\"><img src='images/plus_icon.png' width='20' height='20' border='0'></a></td><td width=15 align='center'><img id='info' onClick=\"top.location.href='update/edit_operatoru.php?id=%s';\" src='images/edit_icon.png' width='20' height='20' border='0'></td><td width=15 align='center'><img id='info' onClick=\"top.location.href='update/insert_operatoru.php?id=%s';\" src='images/del_icon.png' width='20' height='20' border='0'></td><td>%s</td><td>%s</td><td>%s</td></tr>",$myrow['ID'],$myrow['ID'],$myrow['ID'],$myrow['oper'],$myrow['priznak'],$myrow['schet']);
