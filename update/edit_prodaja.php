...
<table width="400" cellpadding="10" cellspacing="0" style="border:1px solid #fff;">
  <tr>
    <td colspan="2" align="center" style="background:url(../images/header-bg.gif); text-align:center; color:#cfdce7; border:1px solid #fff; border-right:none; height:20px;"><b><p>Редактировать продажу</p></b></td>
    </tr>
  ...
  <tr bgcolor="#ecf2f6">
    ...
    <td><select name="b">
    	<?php 
    	if ($myrow['b'] == "А") {printf("<option selected = 'selected' value=\"А\">Аксесуары</option>");} else {printf("<option value=\"А\">Аксесуары</option>");}
		if ($myrow['b'] == "Т") {printf("<option selected = 'selected' value=\"Т\">Терминалы</option>");} else {printf("<option value=\"Т\">Терминалы</option>");}
		if ($myrow['b'] == "С") {printf("<option selected = 'selected' value=\"С\">Стартовые</option>");} else {printf("<option value=\"С\">Стартовые</option>");}
		if ($myrow['b'] == "П") {printf("<option selected = 'selected' value=\"П\">Подключения</option>");} else {printf("<option value=\"П\">Подключения</option>");}
    	?></select></td>
  </tr>
  <tr bgcolor="#dce6ee">
	<td><p>Магазин:</p></td>
