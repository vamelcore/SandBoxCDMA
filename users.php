	...
	<table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable" width="350">
		<thead>
			<tr>
				...
				<th width="50" class="nosort"><h3>Вознаг.за ТП при возврате</h3></th>
