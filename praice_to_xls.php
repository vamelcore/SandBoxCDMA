...
$page->setCellValue("A1", "Оператор")->getStyle('A1')->applyFromArray($boldFont)->applyFromArray($center);
$page->setCellValue("B1", "Тарифный план")->getStyle('B1')->applyFromArray($boldFont)->applyFromArray($center);
$page->setCellValue("C1", "Стоимость подключения")->getStyle('C1')->applyFromArray($boldFont)->applyFromArray($center);
$page->setCellValue("D1", "Вознаграждение")->getStyle('D1')->applyFromArray($boldFont)->applyFromArray($center);	
}
